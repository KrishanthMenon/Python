import numpy as np
from keras.models import Conv2D, Input, BatchNormalization, LeakyReLU, ZeroPadding2D, UpSampling2D
from keras import add, concatenate
    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite(
                    "G:/Traffic Violation Detection/Traffic Signal Violation Detection System/Detected Images/violation_" + str(
                        dcnt) + ".jpg", cimg)
                dcnt = dcnt + 1
            else:
